            ...
            <div class="card-body">
                ...
                <form method="POST" action="add.php">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="annee" class="form-select" type="number" required>
                     ...
                     <div class="mb-3">
                        <label class="form-label">Nombre de livres</label>
                        <input type="number" name="nbrBook" class="form-control" value="5" min="1" required>
                     </div>
